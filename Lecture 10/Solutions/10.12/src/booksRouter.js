...
import { authenticateAdmin } from '../../10.11/src/middleware.js'

import { validatePostRequest, validatePutRequest } from './middleware.js'
...
router.post('/', authenticateAdmin, validatePostRequest, (req, res) => {
...
router.put('/:id', authenticateAdmin, validatePutRequest, (req, res) => {
