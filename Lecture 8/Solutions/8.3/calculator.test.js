...
describe('Adding stupidly simple tests just to get more coverage', () => {
    ...
    it('should give an error on invalid input', () => {
        expect(calculator('makkara')).toEqual('Can\'t do that!')
    })
})